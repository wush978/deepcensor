...
def get_data(config):
    ...
    data_path = join(data_root, "wide-X-data.npy")
    indices_path = join(data_root, "wide-X-indices.npy")
    indptr_path = join(data_root, "wide-X-indptr.npy")
    shape_path = join(data_root, "wide-X-shape.npy")
